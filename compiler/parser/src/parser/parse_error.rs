...
pub(crate) enum ParseErrorContext {
    ...
    DestructureTarget,
    VariableDeclaration,
    ImportDefFirstSegment,
    ImportDefSegment,
    ImportDefSeparator,
    ImportDefGroupSeparator,
    ImportDefGroupEnd,
    TraitName,
    TraitWhere,
    TraitEnd,
...
impl ParseErrorContext {
    ...
    fn context_name<'a>(self) -> &'a str {
        match self {
            ...
            ParseErrorContext::DestructureTarget => "a reference in a destructure target",
            ...
            ParseErrorContext::PrefixPatternPattern => "a pattern after a prefix operator",
            ...
            ParseErrorContext::VariableDeclaration => "a variable declaration",
            ParseErrorContext::ImportDefFirstSegment => "the first import segment",
            ParseErrorContext::ImportDefSegment => "an import statement",
            ParseErrorContext::ImportDefSeparator => "the ‘::’ between import segments",
            ParseErrorContext::ImportDefGroupSeparator => "the comma between imports inside an import group",
            ParseErrorContext::ImportDefGroupEnd => "the end of an import group",
